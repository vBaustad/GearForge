...
export function LandingPage() {
  ...
  return (
    <>
      <SEO
        title="WoW Housing Designs - Browse & Share Midnight Player Housing"
        description="Discover cozy World of Warcraft housing creations for Midnight and TWW. Browse community designs, copy import strings, and share your own aesthetic builds. Free gallery of bedroom, tavern, and garden layouts."
        url="/"
        keywords="WoW housing, WoW Midnight housing, World of Warcraft housing, TWW housing, The War Within housing, housing import strings, cozy WoW home, WoW housing designs, blood elf housing, night elf housing, WoW bedroom layout, WoW tavern build, aesthetic WoW housing, housing inspiration, best WoW builds, share WoW house, Quel'Thalas housing"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "WebApplication",
          name: "GearForge",
          description: "A community platform for sharing World of Warcraft housing designs",
          url: BASE_URL,
          applicationCategory: "Game Companion",
          ...
          aggregateRating: stats && stats.designCount > 0 ? {
            "@type": "AggregateRating",
            ratingCount: stats.designCount,
            bestRating: "5",
            worstRating: "1",
          } : undefined,
        }}
          ...
          <div className="hero-grid">
            ...
            {featured && (
              <div className="hero-featured">
                ...
                <Link to={`/design/${featured._id}`} className="hero-featured-card">
        ...
        <section className="discovery-section">
          <div className="container">
            <div className="section-header">
              ...
              <Link to="/browse?sort=popular" className="section-link">
                See All
                <ArrowRight size={16} />
              </Link>
            </div>
      ...
      <section className="discovery-section">
        <div className="container">
          <div className="section-header">
            ...
            <Link to="/browse?sort=newest" className="section-link">
              See All
              <ArrowRight size={16} />
            </Link>
          </div>
